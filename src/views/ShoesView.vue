<template>
    <div class="admin bg-bg bg-auto bg-top px-[8%] pb-[5rem] flex w-[100%] flex-wrap">
      ...
      <div class="md:w-[50%] w-[100%] mb-[10%] sm:mb-0 relative z-[100]" v-for="product in products" :key="product.id">
        <router-link :to="'/product/' + product.id">
          <div class="relative flex justify-center items-center">
            <img class=" relative object-cover" src="../images/product-bg.png" alt="">
            <img class="absolute w-[41%] h-[59%] object-cover object-center " :src="product.productImages[0]" :alt="product.productName" />
          </div>
